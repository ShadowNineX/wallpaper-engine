...
| `metadataFile` | Auto-created non-null, non-array top-level JSON object; synchronizes editor state and preview bytes under `<metadataFile>.assets/<preview>` for portable builds |
